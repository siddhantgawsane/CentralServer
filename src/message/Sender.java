...
public class Sender implements Runnable {
    ...
    String message = null;
    private String csca = com.util.ServerConstants.SMS_CENTER_NO; // the message center
    private SerialParameters defaultParameters = new SerialParameters( com.util.ServerConstants.COM_PORT_NO, 9600, 0, 0, 8, 1, 0);
    public int step;
    public int status = -1;
    ...
    public static void main(String[] args) {
        String sms[] = {"+919370348616"};
        for (int i = 0; i < sms.length; i++) {

            Sender sender = new Sender(sms[i], "hi ");
            try {
                sender.send();
                Thread.sleep(4000);
            } catch (Exception e) {
